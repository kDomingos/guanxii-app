...
class PersonalProfileScreen extends StatefulWidget {
  ...
  PersonalProfileScreen(this.name, this.isedit, this.docid, this.usingprofile);
...
class _PersonalProfileScreenState extends State<PersonalProfileScreen> {
  ...
  getuserdata() async {
    ...
    if (docSnapshot.exists) {
      ...
      var birthday =
          data?['dateOfBirth']; // <-- The value you want to retrieve.
  ...
  Future uploadImageToFirebase(BuildContext context) async {
    ...
    taskSnapshot.ref.getDownloadURL().then(
      (value) {
        setState(() {
          // final bytes =
          //     File(_imageFile!.path.split('/').last).readAsBytesSync();
          //_filename = base64Encode(bytes);
          img_URL = value;
          print("Done: $value");
        });
      },
  ...
  Future pickImage() async {
    ...
    setState(() {
      ...
      print("Image File HEREEEEEEEEEEEEEE");
      //print(_filename);
    });
  }
          ...
          builder: (context) => AlertDialog(
            ...
            actions: <Widget>[
              ElevatedButton(
                ...
                style:
                    ElevatedButton.styleFrom(primary: const Color(0xFF62AEFB)),
              ),
              ElevatedButton(
