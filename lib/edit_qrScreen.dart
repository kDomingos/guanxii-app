...
class _EditQRScreenState extends State<EditQRScreen> {
  ...
  Widget progressBar() {
    return CircularPercentIndicator(
      ...
      footer: Padding(
        ...
        child: new Text(
          "Please wait we are updating and saving the qr.",
          style: new TextStyle(
  ...
  void initState() {
    super.initState();
    print(widget.usingprofile + "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa");
  ...
  Future<void> qrdataforpersonalprofile() async {
    if (widget.usingprofile == "personl") {
      ...
      //vCard.photo.attachFromUrl(widget.image, 'JPEG');
